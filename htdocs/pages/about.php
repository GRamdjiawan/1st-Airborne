            ...
            <ul class="social-menu reset-list-style social-icons fill-children-current-color">
              ...
              <li id="menu-item-2267" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2267">
                <a title="Facebook" target="_blank" rel="noopener"
                  href="https://www.facebook.com/groups/353236925187490"><span
                    class="screen-reader-text">Facebook</span><svg class="svg-icon" aria-hidden="true" role="img"
                    focusable="false" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <li id="menu-item-2271" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2271">
                <a title="HLL Reddit" target="_blank" rel="noopener" href="https://www.reddit.com/r/HellLetLoose/"><span
                    class="screen-reader-text">Reddit</span><svg class="svg-icon" aria-hidden="true" role="img"
                    focusable="false" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
      ...
      <div class="post-inner  ">
        <div class="entry-content">
          <p class="has-text-align-left has-background-background-color has-text-color has-background"
            style="color:#e0e0e0; font-weight: none;"> Welcome to the 1st Airborne [1stA] clan! </p>
          <p class="has-text-align-left has-background-background-color has-text-color has-background"
            style="color:#e0e0e0;font-size:-1px">We were founded by a small group of friends that originated from the
            game Hell Let Loose. The 1stA clan is an inclusive gaming community, our top priority is having fun and we
            treat each other with respect. </p>
          <p class="has-text-align-left has-background-background-color has-text-color has-background"
            style="color:#e0e0e0;font-size:-1px">We strive to become a bigger clan in the future.</p>
          <p class="has-text-align-left has-background-background-color has-text-color has-background"
            style="color:#e0e0e0;font-size:-1px">We are recruiting. The 1stA clan is always looking for new fun people
            to join our community of players (for competition or for fun).</p>
          <p class="has-text-align-left has-background-background-color has-text-color has-background has-larger-font-size"
            style="color:#e0e0e0">1st Airborne All the Way!</p>
          <p></p>
        </div><!-- .entry-content -->
      </div><!-- .post-inner -->
