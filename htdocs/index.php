...
<html class="no-js" lang="en-GB">
  <head>
    ...
    <link
      ...
      title=" &raquo; Feed"
      href="https://82nd.gg/feed/"
    />
    <link
      rel="alternate"
      type="application/rss+xml"
      title=" &raquo; Comments Feed"
      href="https://82nd.gg/comments/feed/"
    />
    <script>
    ...
    <link
      ...
      href="/assets/css/classic-themes.min.css"
      media="all"
    />
    <style id="global-styles-inline-css">
      body {
        ...
        --wp--preset--color--background: #0a0404;
    ...
    <link
      rel="stylesheet"
      id="rt-tpg-css"
      href="assets/css/thepostgrid.css"
      media="all"
    />
    <link
      rel="stylesheet"
    ...
    <style id="twentytwenty-style-inline-css">
      ...
      .wp-block-table.is-style-stripes {
        border-bottom-color: #4f1111;
      }
      .wp-block-latest-posts.is-grid li {
        border-top-color: #4f1111;
      }
    ...
    <script
      type="text/javascript"
      src="https://82nd.gg/wp-content/themes/82ndAD/assets/js/index.js?ver=1.4.6"
    ...
    <link
      ...
      href="https://82nd.gg/wp-json/wp/v2/pages/55"
    />
    <link
      rel="EditURI"
      type="application/rsd+xml"
      title="RSD"
      href="https://82nd.gg/xmlrpc.php?rsd"
    />
    <link
      rel="wlwmanifest"
      type="application/wlwmanifest+xml"
      href="https://82nd.gg/wp-includes/wlwmanifest.xml"
    />
    ...
    <link
      rel="icon"
      href="https://82nd.gg/wp-content/uploads/2019/12/cropped-82nd_square-1-32x32.png"
      sizes="32x32"
    />
    <link
      rel="icon"
      href="https://82nd.gg/wp-content/uploads/2019/12/cropped-82nd_square-1-192x192.png"
      sizes="192x192"
    />
    <link
      rel="apple-touch-icon"
      href="https://82nd.gg/wp-content/uploads/2019/12/cropped-82nd_square-1-180x180.png"
    />
    <meta
  ...
  <body
    class="home page-template page-template-templates page-template-template-full-width page-template-templatestemplate-full-width-php page page-id-55 custom-background wp-custom-logo cbc-page singular has-full-width-content missing-post-thumbnail has-no-pagination not-showing-comments show-avatars template-full-width footer-top-visible"
  >
        ...
        <div class="menu-wrapper section-inner">
          ...
          <div class="menu-bottom">
            <nav aria-label="Expanded Social Links" role="navigation">
              <ul
                class="social-menu reset-list-style social-icons fill-children-current-color"
              >
                <li
                  id="menu-item-31"
                ...
                >
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    href="https://discord.gg/DN2gvn9Mxe"
                    ><span class="screen-reader-text">Join Discord</span
                    ><svg
                      class="svg-icon"
                      aria-hidden="true"
                      role="img"
                ...
                <li
                  id="menu-item-2266"
                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2266"
                >
                  <a
                    title="Twitter"
                    target="_blank"
                    rel="noopener"
                    href="https://twitter.com/82ADHLL"
                ...
                <li
                  id="menu-item-2267"
                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2267"
                >
                  <a
                    title="Facebook"
                    target="_blank"
                    rel="noopener"
                    href="https://www.facebook.com/groups/353236925187490"
                ...
                <li
                  id="menu-item-2271"
                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2271"
                >
                  <a
                    title="HLL Reddit"
                    target="_blank"
                    rel="noopener"
                    href="https://www.reddit.com/r/HellLetLoose/"
            ...
            <ul class="footer-menu reset-list-style">
              ...
              >
                <a
                  ...
                  href="https://82nd.gg/wp-login.php?redirect_to=%2F"
                  >Login / Register</a
                >
              </li>
            </ul>
              ...
              <div class="widget_text widget widget_custom_html">
                <div class="widget_text widget-content">
                  <div class="textwidget custom-html-widget">
                    <iframe
                      src="https://discord.com/widget?id=926091955614646314&theme=dark"
                      class="disco-widget"
                      width="350"
                      height="400"
    ...
    <footer id="site-footer" role="contentinfo" class="header-footer-group">
      <div class="section-inner wp-block-columns">
        <nav
          ...
          class="footer-social-wrapper wp-block-column"
        >
          <ul
        ...
        <div id="footer-credits" class="wp-block-column">
          <a href="https://82nd.gg/privacy" class="privacy-policy"
            >Privacy Policy</a
          >
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=UA-168797935-1"
    ></script>
    <script>
